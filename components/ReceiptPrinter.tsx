...
const receiptToothCount = 32;
const receiptToothDepth = 7;
...
const machineClassName =
  "relative isolate w-full overflow-hidden rounded-[var(--printer-radius)] border border-[#383838] bg-[#282828] p-[var(--printer-inset)] pb-8 shadow-[0_28px_50px_-15px_rgba(0,0,0,0.8),0_10px_24px_-8px_rgba(0,0,0,0.6),inset_0_1px_0_rgba(255,255,255,0.12),inset_0_-1px_0_rgba(0,0,0,0.5)] [--printer-inner-radius:calc(var(--printer-radius)_-_var(--printer-inset))] [--printer-inset:0.875rem] [--printer-radius:1.75rem] before:pointer-events-none before:absolute before:inset-0 before:z-0 before:rounded-[inherit] before:bg-[url('/textures/plastic-noise.svg')] before:bg-[length:180px_180px] before:bg-repeat before:opacity-20 before:mix-blend-overlay before:content-['']";
  ...
  return (
    <ReceiptPrinterContext.Provider value={context}>
      <section
        ...
        className={cn(
          "relative isolate flex w-full max-w-[430px] flex-col items-center",
          className,
        )}
        data-stage={stage}
        {...props}
...
function ReceiptPrinterMachine({
  ...
  return (
    <div className={cn(machineClassName, className)} {...props}>
      ...
      <div
        aria-hidden="true"
        className="absolute inset-x-8 bottom-[var(--printer-inset)] z-40 h-2.5 rounded-[0.3rem] border border-[#404040] bg-[#141414] shadow-inner shadow-black/90"
      />
    </div>
  );
}
...
function ReceiptPrinterHeader({
  ...
  return (
    <div
      className={cn(
        "relative z-10 flex h-14 items-center justify-between px-1.5",
        className,
      )}
      {...props}
    >
...
function ReceiptPrinterScreen({
  ...
  return (
    <div
      className={cn(
        "relative z-10 isolate overflow-hidden rounded-[var(--printer-inner-radius)] border border-[#1a1a1a] bg-[#141414] p-5 text-neutral-100 shadow-inner shadow-black/95 after:pointer-events-none after:absolute after:inset-0 after:z-20 after:rounded-[inherit] after:shadow-[inset_0_0_24px_4px_rgba(0,0,0,0.8)] after:content-['']",
        className,
      )}
      {...props}
    >
...
function ReceiptPrinterPaper({
  ...
  return (
    <article
      className={cn(
        "relative z-10 min-h-[22rem] bg-grayscale-1 bg-[url('/textures/receipt-paper.svg')] bg-cover px-7 pt-8 pb-12 font-mono text-grayscale-12 bg-blend-soft-light dark:bg-grayscale-12 dark:text-grayscale-1",
        className,
      )}
...
function ReceiptPrinterOutput({
  ...
  return (
    <div
      className={cn(
        "relative z-50 -mt-4 h-[31rem] w-[calc(82%+3rem)] max-w-full overflow-hidden px-6 pb-8",
        className,
      )}
      {...props}
    >
