"use client";
// Form logic updated for Google Sheets integration
...
function LoginPage({ formType = "member" }: LoginPageProps) {
  ...
  return (
    <div className="grid lg:grid-cols-2 overflow-hidden">
      ...
      <div className="relative hidden lg:flex flex-col justify-between p-12 text-foreground">
        ...
        {/* Decorative elements */}
        <div className="absolute inset-0 bg-grid-black/[0.05] bg-[size:20px_20px]" />
      ...
      {/* Right Login Section */}
      <div className="flex items-center justify-center p-8">        <div className="w-full max-w-[420px]">
          {status === "success" ? (
            <div className="text-center space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-black/60">Thank you for joining. Your details have been submitted successfully. We'll be in touch soon.</p>
              </div>
              <Button 
            ...
            <>
              ...
              <div className="text-center mb-10">
                <h1 className="text-3xl font-bold tracking-tight mb-2">Fill Details</h1>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-2">
                  <Label htmlFor="message" className="text-sm font-medium">Message / Why do you want to join?</Label>
                  <textarea
                    id="message"
                    ...
                    onFocus={() => setIsTyping(true)}
                    onBlur={() => setIsTyping(false)}
                    className="flex w-full rounded-md border border-border/60 bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 focus:border-primary min-h-[80px]"
                  />
                </div>
