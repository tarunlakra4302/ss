...
export function ThreeDCardDemo({
  ...
  return (
    <CardContainer className="inter-var w-full" containerClassName="py-2 sm:py-4 w-full">
        ...
        <div className="flex flex-col w-full">
          <div className="flex justify-between items-start w-full gap-4">
            <CardItem
              as="h3"
              translateZ="50"
              className="text-xl sm:text-2xl font-bold tracking-tight text-neutral-900 dark:text-white flex-1"
            >
              {title}
            </CardItem>
            {date && (
